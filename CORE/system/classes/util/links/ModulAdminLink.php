...
class ModulAdminLink extends CMSLink
{
    ...
    function ModulAdminLink($modul = null) {
        ...
        $this->setAction('util');
        $this->setSubAction('moduladmin');
        $this->setFilename('moduladmin.html');
        if(!is_null($modul)) {
        	$this->addParameter('modul', $modul);
        }
    }
}

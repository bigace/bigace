...
/**
 * This class generates a Link to the Registration Formular.
 *
 ...
 * @subpackage util.links
 */
class RegistrationLink extends CMSLink
{
    ...
    function RegistrationLink() {
        ...
        $this->setAction('auth');
        $this->setSubAction('register');
        $this->setFilename('register.html');

 ...
 */
    ...
    $deleteSystemFiles = array(
    				...
    				// -------------------------------------------------------------------------------------
    				// deprecated with 2.7 (not used, replaced, removed ...)
    				"consumer/cid{CID}/presentation/layout/error/error_maintenance.php",
    				"system/language/de/itemMenu.properties",
    				"system/language/en/itemMenu.properties",
    				"system/application/auth/formular.php",
    				"system/sql/logging_delete.sql",
    				"system/admin/templates/LoggingView.tpl.htm",
    				"system/sql/right_delete_item_rights",
    				"system/language/de/manual.properties",
    				"system/language/en/manual.properties",
    				"system/language/de/license.properties",
    				"system/language/en/license.properties",
    				"system/language/de/feedback.properties",
    				"system/language/en/feedback.properties",
    				"system/language/de/credits.properties",
    				"system/language/en/credits.properties",
     				"system/admin/plugins/credits.php", 
     				"system/admin/plugins/feedback.php", 
     				"system/admin/plugins/license.php", 
    				"system/admin/templates/AdminFeedback.tpl.htm",
    				"system/admin/templates/AdminLicense.tpl.htm",
    );
    ...
    $systemSqlToExecute = array(
		...
		'DELETE FROM `'.$_BIGACE['db']['prefix'].'configuration` WHERE `package` = "admin" AND `name` = "dimension.large.mode"'
	);
...
else
{
    ?>
        ...
        <tr><td valign="top" class="upgradecolumn">
            ...
            {
                foreach($communities AS $id => $settings) { // all communities

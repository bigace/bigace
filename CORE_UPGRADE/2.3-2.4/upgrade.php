 ...
 */
    ...
    define('ACTUAL_VERSION', '2.4');
    define('UPGRADE_INFO_URL', 'http://www.bigace.de/upgrade.html');
    ...
    $communityXmlFiles = array(
                    COMMUNITY_XML,
                    _BIGACE_DIR_ROOT."consumer/cid{CID}/install/applications.xml",
    ...
    $systemSqlToExecute = array(
	    'UPDATE '.$_BIGACE['db']['prefix'].'user u, '.$_BIGACE['db']['prefix'].'user_attributes a SET u.email = a.attribute_value WHERE a.userid = u.id AND a.attribute_name = "email" AND a.cid = u.cid',
	    'UPDATE '.$_BIGACE['db']['prefix'].'configuration SET type = "template" WHERE package = "templates"',
	    'UPDATE '.$_BIGACE['db']['prefix'].'item_1 SET num_1 = NULL WHERE num_1 = 0',
	    'UPDATE '.$_BIGACE['db']['prefix'].'item_4 SET num_1 = NULL WHERE num_1 = 0',
	    'UPDATE '.$_BIGACE['db']['prefix'].'item_5 SET num_1 = NULL WHERE num_1 = 0',
	    'UPDATE '.$_BIGACE['db']['prefix'].'item_1 SET num_2 = NULL WHERE num_2 = 0',
	    'UPDATE '.$_BIGACE['db']['prefix'].'item_4 SET num_2 = NULL WHERE num_2 = 0',
	    'UPDATE '.$_BIGACE['db']['prefix'].'item_5 SET num_2 = NULL WHERE num_2 = 0',
	    'ALTER TABLE '.$_BIGACE['db']['prefix'].'item_1 CHANGE num_1 num_1 INT( 11 ) NULL',
	    'ALTER TABLE '.$_BIGACE['db']['prefix'].'item_4 CHANGE num_1 num_1 INT( 11 ) NULL',
	    'ALTER TABLE '.$_BIGACE['db']['prefix'].'item_5 CHANGE num_1 num_1 INT( 11 ) NULL',
	    'ALTER TABLE '.$_BIGACE['db']['prefix'].'item_1 CHANGE num_2 num_2 INT( 11 ) NULL',
	    'ALTER TABLE '.$_BIGACE['db']['prefix'].'item_4 CHANGE num_2 num_2 INT( 11 ) NULL',
	    'ALTER TABLE '.$_BIGACE['db']['prefix'].'item_5 CHANGE num_2 num_2 INT( 11 ) NULL',
    );
    ...
    ?>
        ...
        <tr><td valign="top" class="upgradecolumn">
            ...
            <form action="<?php echo UPGRADE_INFO_URL; ?>" method="GET">
                ...
                <hr>
                <font color="red"><b>** If you used URL Rewriting, please read the next instructions careful **</b></font>
                <hr>
                Hit the button to read further instructions. <input type="submit" value="Last Step...">
            </form>
            </div>
        </td></tr>
        <?php

 ...
 */
    ...
    define('ACTUAL_VERSION', '2.5');
    define('UPGRADE_INFO_URL', 'utf8.php');
    ...
    $systemSqlToExecute = array(
    	...
    	//'ALTER TABLE `'.$_BIGACE['db']['prefix'].'unique_name` ADD `command` VARCHAR( 20 ) NOT NULL AFTER `cid` ;',
    	//'ALTER TABLE `'.$_BIGACE['db']['prefix'].'unique_name` CHANGE `itemid` `itemid` VARCHAR( 50 ) NOT NULL ',
    	//'UPDATE `'.$_BIGACE['db']['prefix'].'unique_name` SET command = "smarty" WHERE itemtype = "1"',
    	//'UPDATE `'.$_BIGACE['db']['prefix'].'unique_name` SET command = "image" WHERE itemtype = "4"',
    	//'UPDATE `'.$_BIGACE['db']['prefix'].'unique_name` SET command = "file" WHERE itemtype = "5"',
    	//'ALTER TABLE `'.$_BIGACE['db']['prefix'].'unique_name` DROP `itemtype`',
    	//'ALTER TABLE `'.$_BIGACE['db']['prefix'].'unique_name` DROP PRIMARY KEY , ADD PRIMARY KEY ( `cid` , `command` , `itemid` , `language` , `name` )'
    );
    ...
    ?>
        ...
        <tr><td valign="top" class="upgradecolumn">
            ...
            <form action="<?php echo UPGRADE_INFO_URL; ?>" method="GET">
                ...
                <hr>
                <font color="red"><b>** You will now be redirected to the database UTF-8 migration script **</b></font>
                <hr>

...
<body>
		<div class="header">
            <table border="0">
                <tr>
                    <td valign="center"><img src="http://www.bigace.de/public/bigace/bigace_logo.png" border="0" style="margin-right:10px;"></td>
    ...
    ?>
        ...
        <tr><td valign="top" class="upgradecolumn">
            ...
            <form name="" action="index.php" method="GET">
                ...
                Hit the button to launch your Website. <input type="submit" value="Go to Website...">
            </form>
            </div>
        </td></tr>
        <?php

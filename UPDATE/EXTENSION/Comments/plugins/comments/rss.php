...
/**
 * This script displays the latest created Comments, by simply loading and parsing 
 * the configured Comments-RSS Template.
...
$tpl = ConfigurationReader::getConfigurationValue('comments', 'rss.latest.template', 'Comments-RSS-Latest');

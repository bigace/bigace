...
<h3>{translate key="choose_file"}</h3>
...
<tbody>
    ...
    <tr>
        <td align="left"><a href="{$entry.ITEM_URL}" onclick="chooseItem('{$entry.ITEM_TYPE}', '{$entry.ITEM_ID}', '{$entry.ITEM_LANGUAGE}', '{$entry.ITEM_FILENAME}', '{$entry.ITEM_URL}', '{$entry.ITEM_MIMETYPE}'); return false;"><img src="{directory name="addon_web"}filemanager/icons/{$entry.ITEM_MIMETYPE}.gif" border="0"></a></td>

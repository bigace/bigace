<?php
// SOME CHANGES FOR BIGACE IN DIRECTORY LOCATION AND ALLOWED CHARACTER!
...
$tempfolder = realpath(dirname(__FILE__).'/b2evo_captcha_tmp/').'/';
...
$TTF_folder = realpath(dirname(__FILE__).'/b2evo_captcha_fonts/').'/';

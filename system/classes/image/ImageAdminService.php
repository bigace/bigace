 ...
 * @subpackage image
 */
class ImageAdminService extends ItemAdminService
{

    function ImageAdminService()
    {
        $this->initItemAdminService( _BIGACE_ITEM_IMAGE );
    }
    ...
    function buildUniqueName($name, $extension, $delim = '_') {
    	if(ConfigurationReader::getConfigurationValue('seo', 'image.use.extension', true))

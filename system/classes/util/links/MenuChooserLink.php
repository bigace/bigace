...
/**
 * This class generates a Link to the Menu Chooser Javascript Application.
 *
 ...
 * @subpackage util.links
 */
class MenuChooserLink extends CMSLink
{

    function MenuChooserLink() {
        ...
        $this->setAction('util');
        $this->setSubAction('jstree');
        $this->setFilename('menuTree.html');
    }

    /**
     * Sets the Javascript function Name that will be called when
